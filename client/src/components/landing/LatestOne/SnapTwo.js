...
import SnapTwoPng from '../../../assets/FeaturedMods_MobileCard_January2019.webp'
...
const CardText = styled.div`
    background-image: linear-gradient(transparent 0%, rgba(193, 146, 89, 0.5) 25%, rgba(193, 146, 89, 0.75) 60%, rgb(193, 146, 89) 90%); 
    left: 0;
    color: #FFF;
    width: 100%;
    bottom: 0;
