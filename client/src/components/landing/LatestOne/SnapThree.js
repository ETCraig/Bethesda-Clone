...
import SnapThreePng from '../../../assets/TESL_IoM_Logo_MOBILE_633x424_EN.webp';
...
const SnapThreeImage = styled.img`
    filter: blur(0px);
        ...
        <SnapThreeWrapper>
            <SnapThreeInnerWrapper>
                <SnapThreeContainer>
                    <a><CardContent>
                        <ImageWrapper>
                            <SnapThreeImage src={SnapThreePng} />
                        </ImageWrapper>
                        <ImageContentWrapper>
                            <CardText>
                                <NewsWrapper>
                                ...
                                <Headline>Prepare yourself for Isle of Madness!</Headline>
                                <Subtitle>The Elder Scrolls: Legends • Jan 11</Subtitle>
                            </CardText>
                        </ImageContentWrapper>
                    </CardContent></a>
                </SnapThreeContainer>
